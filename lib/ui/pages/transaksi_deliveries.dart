...
class DeliveriesItem extends StatefulWidget {
  @override
  _DeliveriesItemState createState() => _DeliveriesItemState();
}

class _DeliveriesItemState extends State<DeliveriesItem> {
  @override
